...
const RevealCard = (props) => (
    ...
    <div className="card small hoverable flow-text">
        ...
        <div className="card-reveal">
            <span className="card-title grey-text text-darken-4">{props.beerName}<i className="fas fa-sort-down right"></i></span>
            <p>{props.details}</p>
            <p>Type:{props.type}</p>
            <p>ABV:{props.abv}%</p>
            <p>IBU{props.ibu}</p>
